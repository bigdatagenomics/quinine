...
import org.bdgenomics.quinine.metrics.{ BucketComparisons, CombinedComparisons, DefaultComparisons }
import org.bdgenomics.quinine.rdd.read.comparisons.ComparisonTraversalEngine
