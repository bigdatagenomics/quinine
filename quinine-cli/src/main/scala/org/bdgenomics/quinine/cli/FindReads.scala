...
import org.bdgenomics.quinine.metrics.filters.{ CombinedFilter, GeneratorFilter }
import org.bdgenomics.quinine.metrics.{ BucketComparisons, DefaultComparisons }
