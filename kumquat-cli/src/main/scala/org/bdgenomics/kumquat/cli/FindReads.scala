...
import org.bdgenomics.kumquat.metrics.filters.{ CombinedFilter, GeneratorFilter }
import org.bdgenomics.kumquat.metrics.{ BucketComparisons, DefaultComparisons }
